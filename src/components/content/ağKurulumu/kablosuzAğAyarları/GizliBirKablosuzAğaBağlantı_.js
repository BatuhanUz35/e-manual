...
export const ol = [
  ...
  <Box>
    <b>Yeni Ağ Ekle</b>'yi seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>SSID giriş menüsü görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    <img src={left} alt="Sol" className="inline-icon sm" />/<img src={right} alt="Sağ" className="inline-icon sm" />
    /<img src={down} alt="Yukarı" className="inline-icon rotate-180 sm" />/<img src={down} alt="Aşağı" className="inline-icon sm" /> düğmesiyle
    ekran klavyesinden SSID'yi girip <img src={continue_icon} alt="Devam et ikonu" className="inline-icon xs" /> tuşunu
    seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Şifre tipi seçim menüsü görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    <b>Yok</b>, <b>WEP</b>, <b>WPA/WPA2 Personal</b> veya <b>WPA3-Personal</b> şifre tipini seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Şifre giriş menüsü görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    <img src={left} alt="Sol" className="inline-icon sm" />/<img src={right} alt="Sağ" className="inline-icon sm" />
