...
export const ol = [
  ...
  <Box>
    <img src={down} alt="Yukarı" className="inline-icon rotate-180 sm" />/<img src={down} alt="Aşağı" className="inline-icon sm" /> düğmesiyle düzenlemek istediğiniz kayıt zamanlayıcısını
    seçip <Circle className="inline-icon button-red button"/> (kırmızı) düğmesine basın.
  </Box>,
  <Box>
    Kayıt zamanlayıcısını düzenleyin.
  </Box>,
  <Box>
    Değişiklikleri kaydetmek için <Circle className="inline-icon button-green button"/> (yeşil) düğmesine basın.
  </Box>
]
