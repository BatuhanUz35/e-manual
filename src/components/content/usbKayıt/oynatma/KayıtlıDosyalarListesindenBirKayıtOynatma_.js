...
export const ol = [
  ...
  <Box>
    <img src={down} alt="Yukarı" className="inline-icon rotate-180 sm" />/<img src={down} alt="Aşağı" className="inline-icon sm" /> düğmesiyle oynatmak istediğiniz yayını
    seçin ve  <Circle className="inline-icon button"/> düğmesiyle başlatın.
  </Box>,
  <Box>
    Oynatmayı duraklatmak için <img src={start} alt="Başla" className="inline-icon" /> düğmesine basın.
  </Box>,
    <Box>
    Oynatmayı durdurmak için <img src={stop} alt="Durdur" className="inline-icon" /> düğmesine basın.
  </Box>
]
