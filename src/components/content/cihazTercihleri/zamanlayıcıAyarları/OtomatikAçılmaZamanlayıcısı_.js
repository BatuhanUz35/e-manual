...
export const ol1 = [
  <Box>
    <b>Zamanlayıcı</b> menüsünden <b>Açılma Zamanı Türü</b>‘nü seçip <Circle className="inline-icon button" /> düğmesine basın.
  </Box>,
  <Box>
    <b>Açık</b> veya <b>Bir defa</b>'yı seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box><b>Açık:</b> Girilen zamanda TV her gün açılır.</Box>
    </Box>
    <Box className="flex-container padding-1">
    <ArrowForwardIcon className="inline-icon xs" /><Box><b>Bir Defa:</b> Girilen zamanda TV bir kere açılır, tekrar etmez.</Box>
    </Box>
  </Box>,
]
...
export const ol2 = [
  <Box>
    <b>Otomatik Açılma Zamanı</b>’nı seçip <Circle className="inline-icon button" /> düğmesine basın.
  </Box>,
  <Box>
