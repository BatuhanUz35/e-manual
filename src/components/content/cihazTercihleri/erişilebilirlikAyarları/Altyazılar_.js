...
export const ol = [
  <Box>
    <b>Erişilebilirlik</b> menüsünden <b>Altyazılar</b>'yi seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box><b>Altyazılar</b> menüsü görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
