...
export const ol = [
  <Box>
    <b>Erişilebilirlik</b> menüsünden <b>Metin - Konuşma</b>'yı seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box><b>Metin-konuşma</b> menüsü görüntülenir.</Box>
    </Box>
  </Box>,
    <Box>
