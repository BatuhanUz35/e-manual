...
export const ol = [
  <Box>
    <b>Klavye</b> menüsünden <b>Gboard Ayarları</b>'nı seçip <Circle className="inline-icon button" /> düğmesine basın.
  </Box>,
  <Box>
    <img src={down} alt="Yukarı" className="inline-icon rotate-180 sm" />/<img src={down} alt="Aşağı" className="inline-icon sm" /> düğmesiyle
    Klavye dilini değiştirebilir, Hizmet Şartları, Gizlilik Politikası, Açık kaynak lisanslarını görüntüleyebilir veya Kullanım istatistiklerini paylaşabilirsiniz.
  </Box>,
  <Box>
