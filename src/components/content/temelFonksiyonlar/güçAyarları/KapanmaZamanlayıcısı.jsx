...
export default function KapanmaZamanlayıcısı() {
  return (
    <Box className="page">
      <p classname="text">Ana sayfa / Televizyonun Çalıştırılması Temel Fonksiyonlar / Güç Ayarları / Kapanma Zamanlayıcısı</p>
      <Box className="container">
        ...
        <ol>
          ...
          <li>
            <b>Kapanma Zamanlayıcısı</b>'nı seçip <Circle className="inline-icon button"/> düğmesiyle onaylayın.
          </li>
          <li>
