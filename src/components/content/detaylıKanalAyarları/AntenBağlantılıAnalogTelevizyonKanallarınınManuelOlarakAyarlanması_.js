...
import analog_manuel_tarama from "../../../assets/images/in-page-images/analog_manuel_tarama.svg"
...
export const ol = [
  ...
  <Box>
    <b>Analog Manuel Tarama</b>'yı seçip <Circle className="inline-icon button" /> düğmesine basın.
    <Box className="flex-container padding-1">
      <img src={analog_manuel_tarama} alt="Analog Manuel Tarama" className="in-page-img" />
    </Box>
  </Box>,
  <Box>
    <b>Başlangıç Frekansı (MHz)</b>'i seçip <Circle className="inline-icon button" /> düğmesine basın. Tarama yapmak istediğiniz 
    frekansı <img src={one} alt="1" className="inline-icon xs"/>...<img src={zero} alt="0" className="inline-icon xs"/> düğmeleriyle girin.
  </Box>,
  <Box>
    Girdiğiniz Frekanstan yukarı doğru arama yapmak için <b>Yukarı Doğru Tara</b>'yı aşağı doğru arama yapmak için <b>şağı Doğru Tara</b>'yı
    seçip <Circle className="inline-icon button" /> düğmesine basın. Tarama yapmak istediğiniz 
  </Box>,
  <Box>
