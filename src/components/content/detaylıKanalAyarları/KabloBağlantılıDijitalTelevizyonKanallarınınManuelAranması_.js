...
import dijital_manuel_tarama from "../../../assets/images/in-page-images/dijital_manuel_tarama.svg"
...
export const ol = [
  ...
  <Box>
    <b>Dijital Manuel Arama</b>'yı seçip <Circle className="inline-icon buttom"/> düğmesine basın.
    <Box className="flex-container padding-1">
      <img src={dijital_manuel_tarama} alt="Kanal Taraması" className="in-page-img" />
    </Box>
  </Box>,
  <Box>
    <b>Frekans</b>'ı seçip <Circle className="inline-icon button"/> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Kanal frekansını <img src={one} alt="1" className="inline-icon xs"/>...<img src={zero} alt="0" className="inline-icon xs"/> düğmeleriyle girin.</Box>
    </Box>
  </Box>,
  <Box>
