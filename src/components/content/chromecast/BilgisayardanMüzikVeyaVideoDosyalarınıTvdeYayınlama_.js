...
export const ol = [
  ...
  <Box>
    <b>Dosya Yayınla</b>‘yı seçin.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Dosya tarayıcısı görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    Yayınlamak istediğiniz müzik veya video dosyasını seçip <b>Yayınla</b> sekmesinde görüntülenen TV'nizi seçip bilgisayarınızın dosyayı TV'nizde görüntüleyin.
  </Box>,
  <Box>
