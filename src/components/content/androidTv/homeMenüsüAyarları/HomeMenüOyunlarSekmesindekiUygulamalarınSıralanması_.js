...
export const ol = [
  <Box>
    ...
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box><b>Oyunlar</b> menüsü görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    Yerini değiştirmek istediğiniz oyunu <Circle className="inline-icon button"/> düğmesiyle seçin.
  </Box>,
  <Box>
    ...
    oyunu yeni konumuna taşıyıp <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
