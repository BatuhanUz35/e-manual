...
export const ol = [
  ...
  <Box>
    Kaldırmak istediğiniz uygulamayı seçip <Circle className="inline-icon button"/> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Uygulama detayları görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    Yüklemeyi Kaldır‘ı seçip <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
    Uygulamayı kaldırma işlemini onaylamak için <b>Tamam</b>'ı veya iptal etmek için <b>İptal</b>'i seçip <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
