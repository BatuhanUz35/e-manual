...
export const ol = [
  ...
  <Box>
    Durdurmak istediğiniz uygulamayı seçip <Circle className="inline-icon button"/> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Uygulama detayları görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    <b>Zorla Durdur</b>'u seçip <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
    Durdurma işlemini onaylamak için <b>Tamam</b>'ı veya iptal etmek için <b>İptal</b>'i seçip <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
