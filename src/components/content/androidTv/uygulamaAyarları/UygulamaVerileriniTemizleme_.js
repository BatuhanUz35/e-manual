...
export const ol = [
  ...
  <Box>
    Verilerini temizlemek istediğiniz uygulamayı seçip <Circle className="inline-icon button"/> düğmesine basın.
    <Box className="flex-container padding-1">
      <ArrowForwardIcon className="inline-icon xs" /><Box>Uygulama detayları görüntülenir.</Box>
    </Box>
  </Box>,
  <Box>
    <b>Veriyi Temizle</b>'yi seçip <Circle className="inline-icon button"/> düğmesine basın.
  </Box>,
  <Box>
